...
export default class Datatable extends LightningElement {
  ...
  pageNumber = 1; //When the page is laoded, pageNumber = 1. After this, pageNumber can be changed(by clicking on "Next" for example), which will trigger our wire service
